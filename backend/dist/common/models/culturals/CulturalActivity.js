...
class CulturalActivity extends Activity_1.default {
    constructor(id, name, startTime, endTime, participants, showVoting = false, stats = []) {
    ...
    static parse(data) {
        ...
        return new CulturalActivity(data.id, data.name, data.startTime, data.endTime, participants, data.showVoting, data.stats);
    }
}
